...
export function Hero() {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen px-4 pt-32 pb-20 overflow-hidden text-center">
      ...
      {/* Background Effects */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-neutral-100/40 via-white to-white" style={{ zIndex: -10 }} />
      ...
      >
        ...
        <h1 className="text-5xl md:text-8xl font-semibold tracking-tighter text-black leading-[1.1]">
          ...
          <span className="text-transparent bg-clip-text bg-linear-to-b from-black to-black/40">
            platform you need.
          </span>
        </h1>
      ...
      >
        <div className="relative rounded-2xl border border-black/10 bg-white/50 backdrop-blur-sm shadow-2xl overflow-hidden group cursor-pointer">
