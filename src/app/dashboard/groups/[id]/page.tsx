    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-purple-800 p-8 text-white shadow-xl">
        ...
        <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-6">
                <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-white/10 backdrop-blur-md text-4xl font-bold shadow-inner border border-white/20">
                    {groupId.charAt(0).toUpperCase()}
                </div>
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">High Rollers Club</h1>
            ...
            <motion.button
                ...
                className="flex cursor-pointer items-center gap-2 rounded-full bg-white px-6 py-3 text-purple-900 shadow-lg transition-all hover:bg-purple-50 hover:shadow-xl font-bold"
            >
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">Active Private Bets</h2>
        ...
        {markets.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center rounded-2xl border border-dashed border-gray-200 bg-gray-50">
                ...
                <button 
                    onClick={() => setIsCreateMarketModalOpen(true)}
                    className="mt-2 text-sm font-bold text-purple-600 hover:underline"
                >
                    Start the first one!
                </button>
            </div>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-gray-900 group-hover:text-purple-700 transition-colors">{market.title}</h3>
                            ...
                            <div className="flex items-center gap-6">
                                <div className="text-right">
                                    ...
                                    <p className="text-lg font-mono font-bold text-green-600">${market.pool}</p>
                                </div>
                                <div className="h-8 w-px bg-gray-100" />
                                <div className="text-right">
                                    <p className="text-xs font-medium text-gray-400 uppercase tracking-wider">Buy-in</p>
                                    <p className="text-lg font-mono font-bold text-gray-900">${market.buy_in}</p>
                                </div>
        ...
        {isCreateMarketModalOpen && (
            ...
            >
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h2 className="text-lg font-bold text-gray-900">Create Private Bet</h2>
                    <button 
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            >
                                <Trophy className="h-5 w-5" />
                                <span className="text-xs font-bold">Winner Takes All</span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="text-xs font-bold">Odd One Out</span>
                            </button>
                        </div>
                    </div>
