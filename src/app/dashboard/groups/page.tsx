    ...
    <div className="space-y-10">
      ...
      >
        <div>
          ...
          <p className="mt-2 text-neutral-600 dark:text-neutral-400">Join communities and create private betting markets</p>
        </div>
        <motion.button
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-3xl font-bold font-mono text-blue-900">{groups.length}</p>
              </div>
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-3xl font-bold font-mono text-green-900">
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-3xl font-bold font-mono text-purple-900">
        ...
        {groups.map((group) => (
          <motion.div key={group.id} variants={item}>
            <Link href={`/dashboard/groups/${group.id}`}>
              <Card className="group h-full cursor-pointer border-none bg-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] transition-all hover:shadow-xl hover:-translate-y-1">
                <CardHeader className="border-b border-gray-50 pb-4">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 text-xl font-bold text-white shadow-md group-hover:from-blue-600 group-hover:to-blue-700 transition-all duration-300">
                        {group.name.charAt(0)}
                      </div>
                      <div>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    ...
                    <div className="rounded-full bg-green-50 px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-green-700">
