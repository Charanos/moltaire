            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-2 text-3xl font-semibold font-mono text-blue-900">{totalSpins}</p>
                </div>
            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-2 text-3xl font-semibold font-mono text-green-900">{totalAwarded}</p>
                </div>
                <div className="rounded-xl bg-white/80 p-3 shadow-sm backdrop-blur-sm">
            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-2 text-3xl font-semibold font-mono text-purple-900">{jackpots}</p>
                </div>
                <div className="rounded-xl bg-white/80 p-3 shadow-sm backdrop-blur-sm">
            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-2 text-3xl font-semibold font-mono text-amber-900">{avgReward}</p>
                </div>
                <div className="rounded-xl bg-white/80 p-3 shadow-sm backdrop-blur-sm">
