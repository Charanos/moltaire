...
import { Shield, TrendingUp, Users, DollarSign, AlertCircle, Search, Plus, Settings, FileText, Activity, Award, Trophy, Wrench, Edit, Eye, Filter } from "lucide-react"
    ...
    <div className="space-y-10">
      ...
      >
        <div>
          ...
          <p className="mt-2 text-neutral-600 dark:text-neutral-400">Manage public betting markets and platform operations</p>
        </div>
        <motion.button
      ...
      >
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-2xl font-bold font-mono text-blue-900">{mockAdminStats.activeMarkets}</p>
              </div>
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-2xl font-bold font-mono text-green-900">
                  {mockAdminStats.totalVolume.toLocaleString()} <span className="text-sm font-sans font-normal text-green-900/40">MP</span>
                </p>
              </div>
              <div className="rounded-xl bg-white/80 p-3 shadow-sm backdrop-blur-sm">
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-2xl font-bold font-mono text-purple-900">{mockAdminStats.participants}</p>
              </div>
              <div className="rounded-xl bg-white/80 p-3 shadow-sm backdrop-blur-sm">
        ...
        <Card className="relative overflow-hidden border-none bg-gradient-to-br from-orange-50 via-white to-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] hover:shadow-lg transition-all cursor-pointer group">
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-900/60">Pending Payouts</p>
                <p className="mt-2 text-2xl font-bold font-mono text-orange-900">{mockAdminStats.pendingPayouts}</p>
              </div>
              <div className="rounded-xl bg-white/80 p-3 shadow-sm backdrop-blur-sm">
        ...
        <Card className="relative overflow-hidden border-none bg-gradient-to-br from-red-50 via-white to-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] hover:shadow-lg transition-all cursor-pointer group">
          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-red-900/60">Pending Settlements</p>
                <p className="mt-2 text-2xl font-bold font-mono text-red-900">{mockAdminStats.pendingSettlements}</p>
              </div>
              <div className="rounded-xl bg-white/80 p-3 shadow-sm backdrop-blur-sm">
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {quickActions.map((section, index) => (
            ...
            >
              <Card className="h-full border-none bg-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] hover:shadow-lg transition-all">
      ...
      >
        <Card className="border-none bg-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium text-gray-600">System Maintenance</p>
                  <p className="text-xs text-gray-400 mt-1">Data repair, integrity checks, and reconciliation tools</p>
                </div>
              </div>
              <motion.button
                whileHover={{ scale: 1.02 }}
      ...
      >
        <Card className="border-none bg-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)]">
          <CardHeader className="border-b border-gray-50 pb-4">
            <div className="flex items-center justify-between">
              <CardTitle className="text-xl font-semibold text-gray-900">Recent Markets</CardTitle>
              <button className="cursor-pointer text-sm font-medium text-blue-600 hover:text-blue-700 hover:underline">View All</button>
            </div>
          </CardHeader>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="text-lg font-bold text-gray-900 group-hover:text-blue-600 transition-colors">{market.title}</h3>
                      ...
                      <div className="mt-5 flex items-center gap-6 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-mono font-bold text-gray-900">${market.buy_in_amount}</span>
                        </div>
                        <div className="h-4 w-px bg-gray-200" />
                        <div className="flex items-center gap-2">
                          <span className="text-gray-400 font-medium">Participants</span>
                          <span className="font-mono font-bold text-gray-900">{market.participant_count}</span>
                        </div>
                        <div className="h-4 w-px bg-gray-200" />
                        <div className="flex items-center gap-2">
                          <span className="text-gray-400 font-medium">Total Pool</span>
                          <span className="font-mono font-bold text-green-600">${market.total_pool}</span>
                        </div>
                      </div>
                    </div>
