...
import { User, Shield, Settings, Award, Check, Mail, Hash, Globe, Bell } from "lucide-react"
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          <Card className="h-full border-none bg-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)]">
            ...
            <CardContent className="pt-6 space-y-6">
              <div className="flex items-center gap-4 rounded-xl bg-gray-50/50 p-4 border border-gray-100">
                <div className="h-16 w-16 rounded-full bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center text-2xl font-bold text-blue-600 shadow-inner">
                  {mockUser.username.charAt(0).toUpperCase()}
                </div>
                <div>
                  <p className="text-lg font-bold text-gray-900">{mockUser.full_name}</p>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-50 via-white to-white p-6 border border-purple-100 shadow-sm">
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div>
                    ...
                    <p className="mt-1 text-2xl font-bold capitalize text-purple-900">
